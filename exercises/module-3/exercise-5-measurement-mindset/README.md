...
แบบฝึกหัดนี้จะช่วยให้พวกเรามอง Agent ในมุมของการวัดผลและการเตรียม UAT มากขึ้น ไม่ใช่แค่สร้างให้ทำงานได้ แต่ต้องเริ่มตอบคำถามว่า **อะไรคือคำว่า good enough สำหรับ Agent ของเรา**
...
Practice นี้ช่วยให้พวกเรากำหนดสิ่งที่จะสังเกตใน UAT เพื่ออธิบายได้ว่า Agent ทำงานได้ดีเพียงใด โดยไม่ต้องตั้งเป้าตัวเลขก่อนมีข้อมูลจริง
...
3. มาลองดูตัวอย่างสิ่งที่ควรสังเกตในแต่ละเรื่องกัน
   ...
   <details>
   <summary>ตัวอย่างสิ่งที่ควรสังเกตใน UAT</summary>
